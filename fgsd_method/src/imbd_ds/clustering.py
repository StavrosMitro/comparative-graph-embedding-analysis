...
CLUSTERING_GRID = {
    'normalization': ['l2', 'standard', 'minmax'],
...
def run_clustering_grid_search(
    ...
    for combo in combinations:
        ...
        try:
            ...
            results.append({'config_name': config_name, **params_used, 'method': 'K-Means', 'ari': km_ari, 'silhouette': km_sil})
            results.append({'config_name': config_name, **params_used, 'method': 'Spectral', 'ari': sp_ari, 'silhouette': sp_sil})
        except Exception as e:
...
def run_clustering_experiment(
    ...
    if visualize and best_X is not None:
        ...
        visualize_clusters(best_X, labels, best_y_kmeans, best_y_spectral, best_config_name, params_str)
