...
# CACHING FUNCTIONS
# =============================================================================
def get_cache_path(dataset_name: str = 'imdb') -> Path:
...
def load_default_params() -> Tuple[Dict[str, OptimalParams], Dict[str, List[int]]]:
    """Load hardcoded default parameters."""
...
def determine_optimal_params_and_bins(
    ...
    if save_plot:
        ...
        ax.hist(viz_data, bins=150, color='skyblue', edgecolor='black', alpha=0.7)
        ...
        ax.set_title(f"IMDB-MULTI: {func_type.upper()} Spectral Distances\n"
        ...
        plt.tight_layout()
        save_path = os.path.join(RESULTS_DIR, f'imdb_preanalysis_{func_type}.png')
